...
# Copied from transformers.models.mistral.modeling_mistral.MistralRotaryEmbedding with Mistral->GPTNeoX
class GPTNeoXRotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # copied from transformers.models.mistral.modeling_mistral.GPTNeoXRotaryEmbedding.forward
...
# copied from transformers.models.mistral.modeling_mistral.MistralLinearScalingRotaryEmbedding with Mistral->GPTNeoX
...
# copied from transformers.models.mistral.modeling_mistral.MistralDynamicNTKScalingRotaryEmbedding with Mistral->GPTNeoX
