...
class StableLmRotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # copied from transformers.models.mistral.modeling_mistral.StableLmRotaryEmbedding.forward
...
# copied from transformers.models.mistral.modeling_mistral.MistralLinearScalingRotaryEmbedding with Mistral->StableLm
...
# copied from transformers.models.mistral.modeling_mistral.MistralDynamicNTKScalingRotaryEmbedding with Mistral->StableLm
...
class StableLmForCausalLM(StableLmPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers.models.mistral.modeling_mistral.MistralForCausalLM.__init__ with Mistral->STABLELM,Mistral->StableLm
    def __init__(self, config):
        super().__init__(config)
