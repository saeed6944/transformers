...
class PersimmonRotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # copied from transformers.models.mistral.modeling_mistral.PersimmonRotaryEmbedding.forward
...
# copied from transformers.models.mistral.modeling_mistral.MistralLinearScalingRotaryEmbedding with Mistral->Persimmon
...
# copied from transformers.models.mistral.modeling_mistral.MistralDynamicNTKScalingRotaryEmbedding with Mistral->Persimmon
...
class PersimmonForCausalLM(PersimmonPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers.models.mistral.modeling_mistral.MistralForCausalLM.__init__ with Mistral->PERSIMMON,Mistral->Persimmon
    def __init__(self, config):
        super().__init__(config)
