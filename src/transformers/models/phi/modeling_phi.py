...
class PhiRotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # copied from transformers.models.mistral.modeling_mistral.PhiRotaryEmbedding.forward
...
# copied from transformers.models.mistral.modeling_mistral.MistralLinearScalingRotaryEmbedding with Mistral->Phi
...
# copied from transformers.models.mistral.modeling_mistral.MistralDynamicNTKScalingRotaryEmbedding with Mistral->Phi
...
class PhiForCausalLM(PhiPreTrainedModel, GenerationMixin):
    ...
    # Copied from transformers.models.mistral.modeling_mistral.MistralForCausalLM.__init__ with Mistral->Phi,bias=False->bias=True
    def __init__(self, config):
        super().__init__(config)
