...
# Copied from transformers.models.mistral.modeling_mistral.MistralRMSNorm with Mistral->Qwen2
...
class Qwen2RotaryEmbedding(nn.Module):
    ...
    @torch.no_grad()
    # copied from transformers.models.mistral.modeling_mistral.Qwen2RotaryEmbedding.forward
